...
```
git remote add upstream https://github.com/project-growth/growth.git
```

### Cut a name spaced feature branch from master
...
1. Uphold the current code standard:
    ...
    - Follow the [airbnb][https://www.npmjs.com/package/eslint-config-airbnb] style-guide
